    ...
    <div class="container">
                    ...
                    <div class="w-full overflow-auto">
                        <div class="flex bg-gray-100">
                            <si-image width="100" height="100"
                                ...
                                v-for="(image, index) in item.images" @click="setImage(index)" :key="index" :src="image.src"
                ...
                <div class="p-2">
                    <div class="p-2 bg-white">
                        ...
                        <si-product-variants class="flex" v-if="item.type == 'variable'" :options="item.options"
                            :images="item.images" :variants="item.variants"
                        ...
                        <div v-else class="flex flex-wrap md:flex-nowrap">
                            <button v-if="$settings.sections.product.booking_this_car.active" @click="addToCart"
            ...
            <div class="p-2 modal_variante_content">
                ...
                <div class="mb-1 w-f row">
                    <div v-if="showVarianteModal">
                        ...
                        <p class="fw-b fs-1">{{ variant.price.salePrice }} {{ $store.state.currency.symbol }} <small
                                class="fw-500" style="color: #2aa900;">{{ variant.quantity.instock >= quantity ?
                ...
                <div class="text-div w-f ai-c">
                    ...
                    <div class="mb-1 border-solid d-f ai-c w-f" @click="showVariantDiv = !showVariantDiv">
                        <div class="d-f ai-c jc-c w-f">
                            <p>{{ t('can_change_choice') }}</p>
                            <svg xmlns="http://www.w3.org/2000/svg" v-if="!showVariantDiv" fill="none" viewBox="0 0 24 24"
        ...
        <div v-if="item" class="flex flex-col">
            ...
            <div v-if="item && $settings.sections.product.reviews.active" class="reviews">
                <sections-reviews v-show="!$store.state.apps.find(a => a.placement.indexOf('REPLACE_REVIEWS') >= 0)"
