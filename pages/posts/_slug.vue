<template>
    <div class="container flex flex-col items-center my-12 bg-white">
        ...
        <div class="flex flex-row">
            ...
            <div>
                <div v-for="itm in item" class="flex flex-col justify-between items-start ">
                    <div class="flex justify-center items-start pt-10">

                        <nuxt-img class="h-full "
                            :src="itm.image && itm.image.url ? itm.image.url : $store.state.defaults.logo"
                    ...
                    <div class="pb-6 font-semibold text-lg">
                        <nuxt-link :to="`/posts/${itm.slug}`" class=" text-black hover:underline">
                            {{ itm.title }}
                        </nuxt-link>
...
export default {
    ...
    async mounted() {
        try {
            ...
            let url = `https://${this.$store.state.domain}/posts/${this.item.slug}`;
