    ...
    <div class="container">
        ...
        <div class="flex flex-wrap">
            <div v-for="(item, i) in items" :key="i" class="p-2"
                :class="mobile_size ? mobile_size : 'w-full sm:w-1/2 md:w-1/3 lg:w-1/4 home-products'">
        ...
        <div v-if="!loading && items.length == 0" class="flex flex-wrap items-center bg-white p-2 mx-2 border rounded">
            <div class="w-full md:w-1/2">
                <svg class="h-40 max-w-full text-gray-400 translate" xmlns="http://www.w3.org/2000/svg" version="1.1"
                    ...
                    x="0" y="0" viewBox="0 0 64 64" style="enable-background:new 0 0 512 512" xml:space="preserve">
                    <g>
        ...
        <div class="flex justify-center" v-if="section.show_more_text">
            <nuxt-link class="py-2 px-4 w-full mx-2 bg-white shadow rounded hover:bg-gray-50 text-primary flex items-center"
                :to="section.show_more_url">
                <span class="w-full">{{ section.show_more_text }}</span>
                <svg class="h-4 text-primary translate" xmlns="http://www.w3.org/2000/svg" version="1.1"
