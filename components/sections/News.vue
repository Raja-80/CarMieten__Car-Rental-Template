    ...
    <div v-if="news_info.show_section" class="container lg:pb-32 pt-32">
        <div class="flex flex-col justify-center items-center pb-28 px-5 ">
            ...
            <p data-aos="fade-up" class="  text-gray-400 font-normal italic font-serif text-lg pb-8">
                ...
                {{ news_info.under_title }}

            </p>

            <p data-aos="fade-up" class="text-black text-center text-sm font-light leading-loose  lg:px-80 px-8">
        ...
        <!-- {{ items[0] }} -->
        <div data-aos="fade-up" v-if="items.length > 0">
            <si-carousel component="si-blog" :list="items" ></si-carousel>
        </div>
...
export default {
    ...
    data() {
        return {
            news_info: this.$settings.sections.news,
            items: [],
        }
    },
    async fetch() {
